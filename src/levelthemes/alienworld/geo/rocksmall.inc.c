...
Gfx _alien_rock_small_tri[] = {
	gsSPVertex(_alien_rock_small_vtx + 0, 16, 0),
	...
	gsSPVertex(_alien_rock_small_vtx + 16, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	...
	gsSPVertex(_alien_rock_small_vtx + 32, 10, 0),
	gsSP1Triangle(0, 1, 2, 0),
