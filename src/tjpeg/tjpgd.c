...
PROGMEM static const uint8_t Zig[64] = {  /* Zigzag-order to raster-order conversion table */
...
PROGMEM static const uint16_t Ipsf[64] = {  /* See also aa_idct.png */
...
#define BYTECLIP(v) pgm_read_byte(&Clip8[(unsigned int)(v) & 0x3FF])

PROGMEM static const uint8_t Clip8[1024] = {
  /* 0..255 */
